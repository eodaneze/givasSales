...
$(document).ready(function() {
    $('#paymentForm').on('submit', function(e) {
        ...
        setTimeout(function() {
            ...
            $.ajax({
                url: 'http://localhost/mainGivas/inc/direct_payment.php',  // Your PHP script to process the payment
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                        ...
                        Swal.fire({
                            ...
                            setTimeout(function() {
                                Swal.fire({
                                    ...
                                    window.location.href = 'http://localhost/mainGivas/register?next';  // Replace with your redirect page
                                });
